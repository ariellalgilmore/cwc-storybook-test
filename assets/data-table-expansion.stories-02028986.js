 ...
 */const D={[`xs (${e.XS})`]:e.XS,[`sm (${e.SM})`]:e.SM,[`md (${e.MD})`]:e.MD,[`lg (${e.LG} - default)`]:e.LG,[`xl (${e.XL})`]:e.XL},m={isSortable:!1,locale:"en",size:e.LG,useStaticWidth:!1,useZebraStyles:!1},M={isSortable:{control:"boolean",description:"Is sortable"},locale:{control:"text",description:"Locale"},size:{control:"radio",description:"Size",options:D},useStaticWidth:{control:"boolean",description:"Use static width"},useZebraStyles:{control:"boolean",description:"Use zebra styles"}},l={render:()=>a`
  ...
  `},d={args:m,argTypes:M,render:({isSortable:w,locale:x,size:u,useStaticWidth:v,useZebraStyles:T})=>a`
    <cds-table
      expandable
      ?is-sortable=${w}
      locale="${x}"
  ...
  `},re={title:"Components/DataTable/Expansion",parameters:{docs:{page:k}}};var t,s,b;l.parameters={...l.parameters,docs:{...(t=l.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => html\`
    <cds-table expandable>
      <cds-table-header-title slot="title">DataTable</cds-table-header-title>
      <cds-table-header-description slot="description"
  ...
  \`
}`,...(b=(s=l.parameters)==null?void 0:s.docs)==null?void 0:b.source}}};var r,n,o;c.parameters={...c.parameters,docs:{...(r=c.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => html\`
    <cds-table expandable batch-expansion>
      <cds-table-header-title slot="title">DataTable</cds-table-header-title>
      <cds-table-header-description slot="description"
  ...
  \`
}`,...(o=(n=c.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};var i,p,h;d.parameters={...d.parameters,docs:{...(i=d.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: defaultArgs,
  argTypes: controls,
  render: ({
    isSortable,
  ...
  \`
}`,...(h=(p=d.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};const ne=["Default","BatchExpansion","Playground"];export{c as BatchExpansion,l as Default,d as Playground,ne as __namedExportsOrder,re as default};
