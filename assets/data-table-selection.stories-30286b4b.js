 ...
 */const R={[`xs (${l.XS})`]:l.XS,[`sm (${l.SM})`]:l.SM,[`md (${l.MD})`]:l.MD,[`lg (${l.LG} - default)`]:l.LG,[`xl (${l.XL})`]:l.XL},B={isSortable:!1,locale:"en",radio:!1,size:l.LG,useStaticWidth:!1,useZebraStyles:!1},H={isSortable:{control:"boolean",description:"Is sortable"},locale:{control:"text",description:"Locale"},radio:{control:"boolean",description:"Radio"},size:{control:"radio",description:"Size",options:R},useStaticWidth:{control:"boolean",description:"Use static width"},useZebraStyles:{control:"boolean",description:"Use zebra styles"}},e={render:()=>s`
    <cds-table>
  ...
  `},d={args:B,argTypes:H,render:({isSortable:k,locale:M,radio:S,size:P,useStaticWidth:g,useZebraStyles:L})=>s`
    <cds-table
      ?is-sortable=${k}
      locale="${M}"
      ?radio=${S}
  ...
  `},pl={title:"Components/DataTable/Selection",parameters:{docs:{page:G}}};var t,b,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => html\`
    <cds-table>
      <cds-table-header-title slot="title">DataTable</cds-table-header-title>
      <cds-table-header-description slot="description"
  ...
  \`
}`,...(r=(b=e.parameters)==null?void 0:b.docs)==null?void 0:r.source}}};var o,n,i;c.parameters={...c.parameters,docs:{...(o=c.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => html\`
    <cds-table is-selectable with-header radio>
      <cds-table-header-title slot="title">DataTable</cds-table-header-title>
      <cds-table-header-description slot="description"
  ...
  \`
}`,...(i=(n=c.parameters)==null?void 0:n.docs)==null?void 0:i.source}}};var h,p,u;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => html\`
    <cds-table is-sortable>
      <cds-table-header-title slot="title">DataTable</cds-table-header-title>
      <cds-table-header-description slot="description"
  ...
  \`
}`,...(u=(p=a.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};var m,w,T;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: defaultArgs,
  argTypes: controls,
  render: ({
    isSortable,
  ...
  \`
}`,...(T=(w=d.parameters)==null?void 0:w.docs)==null?void 0:T.source}}};const ul=["Default","WithRadioSelection","WithSelectionAndSorting","Playground"];export{e as Default,d as Playground,c as WithRadioSelection,a as WithSelectionAndSorting,ul as __namedExportsOrder,pl as default};
