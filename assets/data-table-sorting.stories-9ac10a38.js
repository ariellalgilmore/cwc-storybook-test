 ...
 */const m={[`xs (${l.XS})`]:l.XS,[`sm (${l.SM})`]:l.SM,[`md (${l.MD})`]:l.MD,[`lg (${l.LG} - default)`]:l.LG,[`xl (${l.XL})`]:l.XL},T={isSortable:!0,locale:"en",size:l.LG,useStaticWidth:!1,useZebraStyles:!1},k={isSortable:{control:"boolean",description:"Is sortable"},locale:{control:"text",description:"Locale"},size:{control:"radio",description:"Size",options:m},useStaticWidth:{control:"boolean",description:"Use static width"},useZebraStyles:{control:"boolean",description:"Use zebra styles"}},e={render:()=>o`
  ...
  `},c={args:T,argTypes:k,render:({isSortable:n,locale:i,size:p,useStaticWidth:h,useZebraStyles:u})=>o`
    <cds-table
      ?is-sortable=${n}
      locale="${i}"
      size="${p}"
  ...
  `},dl={title:"Components/DataTable/Sorting",parameters:{docs:{page:w}}};var a,d,s;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => html\`
    <cds-table is-sortable>
      <cds-table-header-title slot="title">DataTable</cds-table-header-title>
      <cds-table-header-description slot="description"
  ...
  \`
}`,...(s=(d=e.parameters)==null?void 0:d.docs)==null?void 0:s.source}}};var t,b,r;c.parameters={...c.parameters,docs:{...(t=c.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: defaultArgs,
  argTypes: controls,
  render: ({
    isSortable,
  ...
  \`
}`,...(r=(b=c.parameters)==null?void 0:b.docs)==null?void 0:r.source}}};const sl=["Default","Playground"];export{e as Default,c as Playground,sl as __namedExportsOrder,dl as default};
