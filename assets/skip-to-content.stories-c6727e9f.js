import{r as a,x as i}from"./lit-element-266f0592.js";import"./skip-to-content-8e1e9b95.js";import{p as n}from"./carbon-element-59fbbccb.js";const r=`.cds--content h2{margin:30px 0}.cds--content h2:first-of-type{margin-block-start:0}
`,h=a(r);/**
 * @license
 *
 ...
 */const e={render:()=>i`
    ...
    <div class="${n}--content ${n}--grid">
      <div class="${n}--row">
        <div class="${n}--col-lg-13">
  ...
  `},d={title:"Components/Skip To Content"};var t,s,o;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      \${styles}
    </style>
  ...
  \`
}`,...(o=(s=e.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};const l=["Default"],f=Object.freeze(Object.defineProperty({__proto__:null,Default:e,__namedExportsOrder:l,default:d},Symbol.toStringTag,{value:"Module"}));export{f as S};
